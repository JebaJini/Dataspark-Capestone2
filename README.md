...
•	Formulate SQL queries to answer specific business questions such as:
     Total and repeated customers.
     Sales trends by store, product, and region.
     Currency impact on sales.
________________________________________
Analysis Steps
1.	Customer Analysis
	Demographics: Analyze gender, age, and location distributions.
	Purchase patterns: Average order value, purchase frequency, and preferred products.
	Segmentation: Identify key customer groups based on purchasing behavior.
2.	Sales Analysis
	Analyze overall sales trends over time.
	Identify top-performing products and stores.
	Examine the impact of exchange rates on sales.
3.	Product Analysis
	Identify most and least popular products.
	Assess profitability and category performance.
4.	Store Analysis
	Evaluate store performance based on size and operational data.
	Perform geographical analysis to identify high-performing regions.
________________________________________
Project Deliverables
1.	Data Cleaning and Preparation
	Provide clean, integrated datasets ready for analysis.
2.	Exploratory Data Analysis (EDA)
	Deliver insights into customer demographics, purchasing behavior, product performance, and store operations.
3.	Data Visualization
	Create interactive dashboards in Power BI/Tableau.
4.	Comprehensive Report
	Summarize findings with actionable recommendations tailored to enhance marketing strategies, inventory management, sales forecasting, and operational decisions.
________________________________________
Results
